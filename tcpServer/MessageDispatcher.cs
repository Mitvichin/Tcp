...
namespace tcpServer
{
	public class MessageDispatcher
	{
		...
		private static void AcceptCallback(IAsyncResult ar)
		{
			...
			try
			{
				ServerServices.Send(handler, SharedMethods.MessageBuilder("Commands: username/username, all/message, chronology/username, onlineUsers/, offlineUsers/, checkOfflineMessages/username" +
